...
var PollWidget = /*#__PURE__*/function (_LitElement) {
  _inherits(PollWidget, _LitElement);
  var _super = _createSuper(PollWidget);
  function PollWidget() {
    var _this;
    ...
    _this.width = 0;
    _this.height = 0;
    _this.question = 'What is your favorite JS View library?';
    _this.options = [{
      id: 1,
      text: 'Lit'
    }, {
  ...
  _createClass(PollWidget, [{
    ...
    value: function connectedCallback() {
      _get(_getPrototypeOf(PollWidget.prototype), "connectedCallback", this).call(this);
    ...
    value: function updated(changedProperties) {
      ...
      if (changedProperties.has('options') && this._showResults) {
        var largetVote = Math.max.apply(Math, _toConsumableArray(this.options.map(function (option) {
          return option.votes;
        })));
        var percentages = this.options.map(function (option) {
          return option.votes / largetVote * 90;
        });
        this.options.forEach(function (option, idx) {
          _this2._option(option.id).animate([{
            width: '90%'
          }, {
            width: "".concat(percentages[idx], "%")
          }], {
            duration: 400,
            easing: 'ease-out',
            fill: 'forwards'
    ...
    value: function render() {
      var _this3 = this;
      var width = this.width ? "".concat(this.width, "px") : 'auto';
      var height = this.height ? "".concat(this.height, "px") : 'auto';
      var dimensions = {
        width: width,
        height: height
      };
    ...
    value: function () {
      var _handleOptionClick = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
        var option;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              option = event.target.closest('#option');
              this._showResults = true;
              _context.next = 6;
              return this.castVote(option.dataset.optionId);
            case 6:
            case "end":
      ...
      function handleOptionClick(_x) {
        return _handleOptionClick.apply(this, arguments);
      }
      return handleOptionClick;
    }()
  }, {
    key: "updatePollResults",
    value: function () {
      var _updatePollResults = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var response, result;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return fetch(this.requestAPI);
            case 2:
      ...
      function updatePollResults() {
        return _updatePollResults.apply(this, arguments);
      }
      return updatePollResults;
    }()
  }, {
    key: "castVote",
    value: function () {
      var _castVote = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
        var response, result;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return fetch(this.voteAPI, {
                method: 'PATCH',
                mode: 'cors',
                headers: {
    ...
    key: "teardownPollUpdater",
    value: function teardownPollUpdater() {
